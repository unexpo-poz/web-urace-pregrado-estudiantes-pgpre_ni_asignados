function prepdata() {
	with(document.datos_p) {
		...
		dirr_e.value = avCalleR.value+';'+barrioR.value+';'+casaR.value+';'+estadoR.value+';'+ciudadR.value;
		...
		//codigo parroquia del plantel
		//document.getElementById('codigo_pquia').value = document.getElementById('codigopquia_S_1').value;
		//alert(document.getElementById('codigo_pquia').value);
		//parroquia nac
		//document.getElementById('tot_raz_v').value = document.getElementById('totraz_S_1').value;
		//alert(document.getElementById('tot_raz_v').value);
		//
	}
}
